...
{
    /**
     * Contoh: php artisan scores:recalculate
     * Tambahkan --dry-run untuk lihat dulu apa yang akan berubah tanpa menyimpan.
     */
    ...
    public function handle(): int
    {
        ...
        // Poin sebenarnya = jumlah kolom 'poin' di quiz_answers untuk semua
        // sesi milik siswa tsb (ini sumber kebenaran yang sesungguhnya,
        // karena quiz_answers tercatat langsung tiap siswa menjawab soal,
        // tidak tergantung apakah dia sempat sampai ke halaman hasil).
        ...
        // Sesi selesai sebenarnya = sesi yang jumlah jawabannya sudah
        // mencapai total_soal (artinya siswa memang menuntaskan semua soal),
        // terlepas dari apakah kolom 'selesai' sempat ke-set atau tidak.
        ...
        foreach ($semuaUserId as $userId) {
            ...
            // Sekalian tandai semua sesi yang sudah tuntas sebagai 'selesai',
            // supaya konsisten dengan kolom baru yang dipakai KuisController.
            if (!$dryRun) {
